...
<head lang="tr">
    <meta charset="UTF-8">
    <title>Safir Bulut Şifre Sıfırlama</title>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style="margin-top: 0; margin-bottom: 30px; font-size: 14px; font-family: 'Roboto', helvetica, arial, sans-serif; color: #383838; font-weight: 300;">
                                                        ...
                                                        Aşağıdaki şifreyi kullanarak Safir Bulut altyapısına bağlanabilirsiniz.</p><br>
                                                    ...
                                                    <p style="margin-top: 0; margin-bottom: 5px; font-size: 14px; font-family: 'Roboto', helvetica, arial, sans-serif; color: #383838; font-weight: 300;">
                                                        Yeni şifreniz: {{ new_password }}</p><br>
