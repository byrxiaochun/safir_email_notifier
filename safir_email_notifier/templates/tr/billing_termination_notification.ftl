...
<head lang="tr">
    <meta charset="UTF-8">
    <title>Safir Bulut Proje Sonlandırma Bildirimi</title>
                                            ...
                                            <tr>
                                                ...
                                                <td bgcolor="#750000"
                                                    ...
                                                    <p style="margin-top: 20px; color: #ffffff; font-size: 20px; font-family: 'Roboto', helvetica, arial, sans-serif; font-weight: 600;">
                                                        Safir Bulut Proje Sonlandırma Bildirimi</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><p>&nbsp;</p></td>
                                            ...
                                            <tr>
                                                <td>
                                                    <p style="margin-top: 0; margin-bottom: 15px; font-size: 14px; font-family: 'Roboto', helvetica, arial, sans-serif; color: #383838; font-weight: 400;">
                                                        Merhaba {{ name }}</p>
                                                    <p style="margin-top: 0; margin-bottom: 15px; font-size: 14px; font-family: 'Roboto', helvetica, arial, sans-serif; color: #383838; font-weight: 400;">
                                                        Safir Bulut projenizin kontör kullanım limitlerini aştığınız için kaynaklarınız
                                                        {{ last_credit_update_time }} tarihinde askıya alınmıştı. <b>Bu tarihten itibaren size tanınan {{ termination_threshold }}
                                                        günlük süre içerisinde kontör yüklemediğiniz için projeniz sonlandırılmıştır. Kontör yükleyerek projenizi tekrar aktif
                                                        hale getirebilirsiniz fakat hesap sonladırma sürecinde daha önce oluşturduğunuz kaynaklarınız silindiği için bu
                                                        kaynaklara erişim sağlayamacaksınız.</b></p>
                                                    ...
                                                    <p style="margin-top: 0; margin-bottom: 20px; font-size: 14px; font-family: 'Roboto', helvetica, arial, sans-serif; color: #383838; font-weight: 400;">
                                                        Yapılan İşlem: <b>{{ name }} projesinin kaynakları sonlandırıldı. </b></p><br>
                                                    ...
                                                    <p style="margin-top: 0; margin-bottom: 0; font-size: 14px; font-family: 'Roboto', helvetica, arial, sans-serif; color: #383838; font-weight: 400;">
                                                        Proje Sonlandırma Süresi: {{ termination_threshold }} gün </p><br>
