...
<head lang="tr">
    <meta charset="UTF-8">
    <title>Safir Bulut Proje Aktifleştirme Bildirimi</title>
                                            ...
                                            <tr>
                                                ...
                                                <td bgcolor="#007500"
                                                    ...
                                                    <p style="margin-top: 20px; color: #ffffff; font-size: 20px; font-family: 'Roboto', helvetica, arial, sans-serif; font-weight: 600;">
                                                        Safir Bulut Proje Aktifleştirme Bildirimi</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><p>&nbsp;</p></td>
                                            ...
                                            <tr>
                                                <td>
                                                    <p style="margin-top: 0; margin-bottom: 15px; font-size: 14px; font-family: 'Roboto', helvetica, arial, sans-serif; color: #383838; font-weight: 400;">
                                                        Merhaba {{ name }}</p>
                                                    <p style="margin-top: 0; margin-bottom: 15px; font-size: 14px; font-family: 'Roboto', helvetica, arial, sans-serif; color: #383838; font-weight: 400;">
                                                        Daha önce askıya alınan Safir Bulut projeniz tekrar aktifleştirilmiştir.
                                                        Askıya alma sürecinde uyku moduna alınmış kaynaklarınızı proje sayfanızı ziyaret ederek tekrar
                                                        aktifleştirebilirsiniz. </p>
                                                    ...
                                                    <p style="margin-top: 0; margin-bottom: 20px; font-size: 14px; font-family: 'Roboto', helvetica, arial, sans-serif; color: #383838; font-weight: 400;">
                                                        Yapılan İşlem: <b>Askıya Alınan Proje Aktif Hale Getirildi : {{ project_id }} </b></p><br>
                                                                    ...
                                                                    <tr>
                                                                        <td bgcolor="#357eaa"
                                                                            ...
                                                                            align="center"><a href="{{ link }}"
                                                                                              ...
                                                                                              Safir Bulut Proje Sayfası</a></td>
                                                                    </tr>
                                                                    </tbody>
                                                                </table>
                                                            </td>
