...
<head lang="tr">
    <meta charset="UTF-8">
    <title>Safir Bulut Hesap Aktivasyonu</title>
                                    ...
                                    <td align="center">
                                        <table cellpadding="0" cellspacing="0" width="100%" height="60" bgcolor="#fff">
                                            ...
                                            <tr>
                                                <td>&nbsp;</td>
                                                <td>
                                                    <p style="margin-top: 10px; color: #2776bd; font-size: 20px; font-family: 'Roboto', helvetica, arial, sans-serif; font-weight: 400;">
                                                        Safir Bulut Hesap Aktivasyonu</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><p>&nbsp;</p></td>
                                ...
                                <tr>
                                    <td>
                                        <table cellpadding="0" cellspacing="0" width="100%"
                                            ...
                                            <tr>
                                                <td>
                                                    <p style="margin-top: 0; margin-bottom: 15px; font-size: 14px; font-family: 'Roboto', helvetica, arial, sans-serif; color: #383838; font-weight: 300;">
                                                        Merhaba {{ name }},</p>
                                                    <p style="margin-top: 0; margin-bottom: 15px; font-size: 14px; font-family: 'Roboto', helvetica, arial, sans-serif; color: #383838; font-weight: 300;">
                                                        Safir Bulut'a Hoş Geldiniz!</p>
                                                    <p style="margin-top: 0; margin-bottom: 20px; font-size: 14px; font-family: 'Roboto', helvetica, arial, sans-serif; color: #383838; font-weight: 300;">
                                                        Bulut altyapısını kullanmaya
                                                        başlamak için e-postanızı doğrulamanız gerekmektedir.</p>
                                                                    ...
                                                                    <tr>
                                                                        <td bgcolor="#357eaa"
                                                                            ...
                                                                            align="center"><a href="{{ link }}"
                                                                                              target="_blank"
                                                                                              style="font-size: 16px; font-family: 'Roboto', helvetica, arial, sans-serif; font-weight: normal; color: #ffffff; text-decoration: none; display: inline-block;font-weight: 900;">E-posta
                                                                            Doğrula</a></td>
                                                                    </tr>
                                                                    </tbody>
                                                                </table>
