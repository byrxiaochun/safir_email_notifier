...
<head lang="tr">
    <meta charset="UTF-8">
    <title>Safir Cloud Project Activation Notice</title>
                                            ...
                                            <tr>
                                                ...
                                                <td bgcolor="#007500"
                                                    ...
                                                    <p style="margin-top: 20px; color: #ffffff; font-size: 20px; font-family: 'Roboto', helvetica, arial, sans-serif; font-weight: 600;">
                                                        Safir Cloud Project Activation Notice</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><p>&nbsp;</p></td>
...
Your {{instance_name}} project and your previously suspended resources are re-activated on Safir Cloud. You can activate your hibernate resources by visiting the project page. </p>
...
<p style="margin-top: 0; margin-bottom: 20px; font-size: 14px; font-family: 'Roboto', helvetica, arial, sans-serif; color: #383838; font-weight: 400;">
                                                    ...
                                                    <p style="margin-top: 0; margin-bottom: 0; font-size: 14px; font-family: 'Roboto', helvetica, arial, sans-serif; color: #383838; font-weight: 400;">
                                                        Credit: {{ credit }}</p><br>
                                                    <p style="margin-top: 0; margin-bottom: 20px; font-size: 14px; font-family: 'Roboto', helvetica, arial, sans-serif; color: #383838; font-weight: 400;">
                                                        Action: <b> Suspented project has been re-activated: {{ instance_name }}</b></p><br>
