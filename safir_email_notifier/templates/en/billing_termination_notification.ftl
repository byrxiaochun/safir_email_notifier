...
<head lang="tr">
    <meta charset="UTF-8">
    <title>Safir Cloud Project Termination Notification</title>
                                            ...
                                            <tr>
                                                ...
                                                <td bgcolor="#750000"
                                                    ...
                                                    <p style="margin-top: 20px; color: #ffffff; font-size: 20px; font-family: 'Roboto', helvetica, arial, sans-serif; font-weight: 600;">
                                                        Safir Cloud Project Termination Notification</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><p>&nbsp;</p></td>
...
Your resources have been suspended on {{last_credit_update_time}} because you have exceeded the credit usage limits in {{instance_name}} project you have rented on Sapphire Cloud. From this date, you have been terminated without a project for which you have not credited within {{termination_threshold}} days recognized. You can reactivate the progeny by loading credits, but you will not have access to these resources because you have already deleted the sources you created earlier in the account termination process.

						    <p style="margin-top: 0; margin-bottom: 0; font-size: 14px; font-family: 'Roboto', helvetica, arial, sans-serif; color: #383838; font-weight: 400;">							Alarm Resource: {{ instance_name }}</p><br>
                                                    ...
                                                    <p style="margin-top: 0; margin-bottom: 0; font-size: 14px; font-family: 'Roboto', helvetica, arial, sans-serif; color: #383838; font-weight: 400;">
                                                        Last Credit Check Time: {{ last_credit_update_time }}</p><br>
						    <p style="margin-top: 0; margin-bottom: 0; font-size: 14px; font-family: 'Roboto', helvetica, arial, sans-serif; color: #383838; font-weight: 400;">
                                                        Credit: {{ credit }}</p><br>
                                                    <p style="margin-top: 0; margin-bottom: 0; font-size: 14px; font-family: 'Roboto', helvetica, arial, sans-serif; color: #383838; font-weight: 400;">
                                                        Action Type: {{ action_type }}</p><br>
                                                                    ...
                                                                    <tr>
                                                                        <td bgcolor="#357eaa"
                                                                            ...
                                                                            align="center"><a href="{{ link }}"
                                                                                              ...
                                                                                              Credit Load Control Panel</a></td>
                                                                    </tr>
                                                                    </tbody>
                                                                </table>
                                                            </td>
