                                            ...
                                            <tr>
                                                ...
                                                <td bgcolor="#750000"
                                                    ...
                                                    <p style="margin-top: 20px; color: #ffffff; font-size: 20px; font-family: 'Roboto', helvetica, arial, sans-serif; font-weight: 600;">
                                                        Safir Cloud Credit Alarm Notification</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><p>&nbsp;</p></td>
...
An alarm has occurred at the credit limit of the source you leased on Sapphire Cloud! That's why the process described below has been applied to the source {{instance_name}}.</p> <p> <b> You have to check your credit limits and load credit.</b></p>
