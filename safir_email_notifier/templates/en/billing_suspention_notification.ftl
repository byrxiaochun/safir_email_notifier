...
<head lang="tr">
    <meta charset="UTF-8">
    <title>Safir Cloud Project Suspension Notification</title>
                ...
                <table style="width: 100%; height: 100%; text-align: center; padding: 5px;">
                    ...
                    <tr>
                        <td>
                                            ...
                                            <tr>
                                                ...
                                                <td bgcolor="#750000"
                                                    ...
                                                    <p style="margin-top: 20px; color: #ffffff; font-size: 20px; font-family: 'Roboto', helvetica, arial, sans-serif; font-weight: 600;">
                                                        Safir Cloud Project Suspension Notification</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><p>&nbsp;</p></td>
							...
							Your resources have been suspended because you have exceeded the limit on credit usage in {{instance_name}} project that you rented on Sapphire Cloud. <b> You need to check your credit limits and re-credited. If you do not charge credits for {{termination_threshold}} days, the project resources will be deleted.</p>
						    ...
						    <p style="margin-top: 0; margin-bottom: 0; font-size: 14px; font-family: 'Roboto', helvetica, arial, sans-serif; color: #383838; font-weight: 400;">
                                                        Credit: {{ credit }}</p><br>
                                                    <p style="margin-top: 0; margin-bottom: 0; font-size: 14px; font-family: 'Roboto', helvetica, arial, sans-serif; color: #383838; font-weight: 400;">
                                                        Action Type: Project Suspended: {{instance_name}} </b> </p> <br>
