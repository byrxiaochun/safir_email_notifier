...
<head lang="tr">
    <meta charset="UTF-8">
    <title>Safir Cloud Account Activation</title>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p style="margin-top: 10px; color: #2776bd; font-size: 20px; font-family: 'Roboto', helvetica, arial, sans-serif; font-weight: 400;">
                                                        Safir Cloud Account Activation</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><p>&nbsp;</p></td>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style="margin-top: 0; margin-bottom: 20px; font-size: 14px; font-family: 'Roboto', helvetica, arial, sans-serif; color: #383838; font-weight: 300;">
                                                        To finish setting up your Safir Cloud Account, please verify
                                                        your e-mail address by clicking the following link.</p>
